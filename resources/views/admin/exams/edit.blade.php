        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 pd-3">
                    ...
                    <form method="POST" action="{{ url("dashboard/exams/update/$exam->id") }}" enctype="multipart/form-data" id="add-form">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="difficulty" value="{{ $exam->difficulty }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label>Duration Mins</label>
                                    <input type="text" name="duration_mins" value="{{ $exam->duration_mins }}" class="form-control">
                                </div>
                            </div>
                            <div>
