    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-12 pb-3">
                          ...
                          <tbody>
                              @foreach ($exam->questions as $ques)
                                  <tr>
                                      ...
                                      <td>
                                          <a href="{{ url("dashboard/exams/edit-questions/$exam->id/$ques->id") }}" type="button" class="btn btn-sm btn-info">
                ...
                <a href="{{ url('dashboard/exams') }}" class="btn btn-sm btn-dark">Back to all exams</a>
            </div>
        </div>
        <!-- /.row -->
        </div><!-- /.container-fluid -->
