            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    <ul class="hero-area-tree">
                        ...
                        <li><a href="{{ url("exams/show/$exam->id") }}">{{ $exam->skill->cat->name() }}</a></li>
                        <li><a href="{{ url("exams/show/$exam->id") }}">{{ $exam->skill->name() }}</a></li>
                        <li>{{ $exam->name() }}</li>
                    </ul>
            ...
            <div class="row">
                ...
                <form id="exam-submit-form" action="{{ url("exams/submit/{$exam->id}") }}" method="post">
                    ...
                    <div>
                        ...
                        <button class="main-button icon-button btn-danger pull-left ml-sm">{{ __('web.Cancel') }}</button>
                    </div>
                </div>
                <!-- /main blog -->  
                <!-- aside blog -->
