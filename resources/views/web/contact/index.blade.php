        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    ...
                    <h1 class="white-text">{{ __('web.contact_us')}}</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        ...
                        <form id="contact-form">
                            ...
                            <button id="contact-form-btn" type="submit" class="main-button icon-button pull-right">{{ __('web.Send Message')}}</button>
                        </form>
                    </div>
                </div>
                <!-- /contact form -->
                ...
                <div class="col-md-5 col-md-offset-1">
                    <h4>{{ __('web.Contact Information')}}</h4>
